    ...
    <div class="row">
        <div class="col-md-6 col-lg-3">
            <div class="card text-center bg-matrix-1 m-20 p-0 border-0">
                <div class="mx-20 my-15 d-flex justify-content-between align-items-center">
                    <h3 class="my-0 pt-0 text-white"><?php echo $count_acc; ?></h3>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card text-center bg-matrix-4 m-20 p-0 border-0">
                ...
                <div class="py-5" style="background: rgba(0,0,0,0.05); border-radius: 0px 0px 10px 10px;">
                    <a href="tools.php" class="text-white">View Tools <i class="fa fa-forward"></i></a>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
        ...
        <div class="col-lg-6">
            <div class="card m-20">
              ...
              <p>
                Now free SSL generation has been provided in order to provide fast website access and increase the security your website.
              </p>
              <div class="text-right">
